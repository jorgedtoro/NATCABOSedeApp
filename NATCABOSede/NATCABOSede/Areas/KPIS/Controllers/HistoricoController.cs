...
namespace NATCABOSede.Areas.KPIS.Controllers
{
    ...
    public class HistoricoController : Controller
    {
        ...
        public IActionResult Historico(int page = 1, int pageSize = 25)
        {
            ...
            //var historico = _context.KpisHistorico
            ...
            //// Total de registros
            //var totalRecords = _context.KpisHistorico.Count();
        ...
        {
            //var query = _context.KpisHistorico.AsQueryable();
        ...
        public IActionResult ExportarExcel([FromBody] FiltrarRequest request)
        {
            ...
            //            worksheet.Cell(row, 4).Value = item.N_Paquetes;
            //            worksheet.Cell(row, 5).Value = item.N_Minutos;
            //            worksheet.Cell(row, 6).Value = item.N_Operaciones;
            //            worksheet.Cell(row, 7).Value = item.TotalWeight;
            //            worksheet.Cell(row, 8).Value = item.FTarget;
            //            worksheet.Cell(row, 9).Value = item.Kpi_Ppm;
            //            worksheet.Cell(row, 10).Value = item.Kpi_Pm;
            //            worksheet.Cell(row, 11).Value = item.Kpi_Extrapeso;
